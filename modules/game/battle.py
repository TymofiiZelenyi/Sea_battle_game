...
def battle():
    ...
    def map(row, cell, number):
        if player_map2[row][cell] == 2:  
            if row != 9 and player_map2[row+1][cell] == 0 and not player_map2[row+1][cell] == 2:
                ...
                print("BUTTON")
            if row != 0 and player_map2[row-1][cell] == 0 and not player_map2[row-1][cell] == 2:
                miss_list.append(pygame.Rect(row_list_enemy[number- 10].x + 25, row_list_enemy[number- 10].y + 25, 10, 10))
                row_list_enemy[number- 10].CLOSE = True
                print("TOP")
            if cell != 0 and player_map2[row][cell-1] == 0 and not player_map2[row][cell-1] == 2:
                ...
                print("LEFT")
            if cell != 9 and player_map2[row][cell+1] == 0 and not player_map2[row][cell+1] == 2:
                miss_list.append(pygame.Rect(row_list_enemy[number+ 1].x + 25, row_list_enemy[number+ 1].y + 25, 10, 10)) 
                row_list_enemy[number+ 1].CLOSE = True 
                print("RIGHT")
            if cell != 0 and row != 0 and player_map2[row-1][cell] == 0 and player_map2[row][cell-1] == 0 and not player_map2[row-1][cell] == 2 and not player_map2[row][cell-1] == 2:
                ...
                print("LEFT TOP")
            if cell != 9 and row != 0 and player_map2[row-1][cell] == 0 and player_map2[row][cell+1] == 0 and not player_map2[row-1][cell] == 2 and not player_map2[row][cell+1] == 2:
                ...
                print("RIGHT TOP")
            if cell != 0 and row != 9 and player_map2[row][cell-1] == 0 and placement_map2[row+1][cell] == 0 and not player_map2[row][cell-1] == 2 and not placement_map2[row+1][cell] == 2:
                miss_list.append(pygame.Rect(row_list_enemy[number+ 9].x + 25, row_list_enemy[number+ 9].y + 25, 10, 10))
                row_list_enemy[number+ 9].CLOSE = True
                print("LEFT BUTTON")
            if cell != 9 and row !=9 and player_map2[row][cell+1] == 0 and placement_map2[row+1][cell] == 0 and not player_map2[row][cell+1] == 2 and not placement_map2[row+1][cell] == 2:
                miss_list.append(pygame.Rect(row_list_enemy[number+ 11].x + 25, row_list_enemy[number+ 11].y + 25, 10, 10))
                row_list_enemy[number+ 11].CLOSE = True
                print("RIGHR BUTTON")
